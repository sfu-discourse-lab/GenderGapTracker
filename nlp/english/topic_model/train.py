...
if __name__ == "__main__":
    ...
    # Get custom outlet names if required (Make sure names are capitalized and comma-separated!)
    if args['outlets']:
        # Assumes that the user provided outlets as a comma-separated list
        outlet_list = args['outlets'].split(",")
    else:
        outlet_list = None
    ...
    OUTLETS = outlet_list if outlet_list else config['MODEL']['OUTLETS']
